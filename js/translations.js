...
const translations = {
  en: {
    ...
    "about.p1": "Art has fascinated me for as long as I can remember — not only for its beauty, but for the stories it tells. Studying art history was the natural first step, and the more I engaged with artworks and their history, the more my enthusiasm for cultural heritage grew.",
    "about.p2": "The turning point came during an internship in Dresden, watching a colleague examine a painting taken out of its frame. Through its materials, brushstrokes and earlier restorations, the artwork told an entirely new story — and I realised that conservator-restorers are, in many ways, detectives of art, reading every crack and paint layer for clues.",
    "about.p3": "Today it's this combination of art, history, science and hands-on precision that drives me. To me, a conservator's task isn't simply to restore artworks, but to understand them, preserve their authenticity, and safeguard them for future generations.",
  ...
  de: {
    ...
    "about.p1": "Kunst fasziniert mich, solange ich denken kann – nicht nur wegen ihrer Schönheit, sondern vor allem wegen der Geschichten, die sie erzählt. Das Studium der Kunstgeschichte war für mich der naheliegende erste Schritt, und je intensiver ich mich mit Kunstwerken und ihrer Geschichte auseinandersetzte, desto mehr wuchs meine Begeisterung für unser kulturelles Erbe.",
    "about.p2": "Der Wendepunkt kam während eines Praktikums in Dresden, als ich beobachtete, wie eine Kollegin ein aus dem Rahmen genommenes Gemälde untersuchte. Durch seine Materialien, Pinselführung und frühere Restaurierungen erzählte das Kunstwerk eine völlig neue Geschichte – und mir wurde klar, dass Konservatorinnen und Restauratoren in vielerlei Hinsicht Detektive der Kunst sind, die jeden Riss und jede Malschicht nach Hinweisen lesen.",
    "about.p3": "Heute ist es genau diese Verbindung aus Kunst, Geschichte, Wissenschaft und handwerklicher Präzision, die mich antreibt. Für mich besteht die Aufgabe einer Restauratorin nicht einfach darin, Kunstwerke zu restaurieren, sondern sie zu verstehen, ihre Authentizität zu bewahren und sie für kommende Generationen zu sichern.",
    "about.p4": "Jedes Kunstwerk trägt seine eigene Geschichte in sich, und zu seiner Erhaltung beizutragen ist für mich sowohl eine große Verantwortung als auch ein Privileg. Ob für ein Museum, eine Galerie, eine Institution oder eine Privatsammlung – ich begegne jedem Objekt mit Neugier, Präzision und größtem Respekt. Denn für mich bedeutet Konservierung nicht nur, Kunstwerke zu bewahren, sondern auch die Geschichten und das Handwerk, die sie in sich tragen.",
